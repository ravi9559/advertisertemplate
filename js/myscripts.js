...
const rooturl =
  "http://sdwebau.shopainternal.com.s3-website-ap-southeast-2.amazonaws.com/json/";

const imagesurl =
  "http://sdwebau.shopainternal.com.s3-website-ap-southeast-2.amazonaws.com/images/";

const indexFile =
  "http://sdwebau.shopainternal.com.s3-website-ap-southeast-2.amazonaws.com/json/aaa_productlist.json";
        ...
        .then((detailsData) => {
          ...
          nestedDataDiv.innerHTML = `
                                  ...
                                  <div class="row  shadow-lg m-5 py-2  bg-white"> 
                                          <div class=" row  py-2   ">  
                                          <div class="col-lg-4 ">
                                           <img src="${imagesurl}coupons/${
            detailsData.ImageUri
          }" class="img-fluid rounded m-3" alt="${detailsData.Headline} with ${
            detailsData.Advertiser
          }">
                                          </div>
...
function getCTA(detailsData) {
  return detailsData.Ctas.map((cta) => {
    if (cta.Type === "Phone") {
...
function getLocation(detailsData) {
  ...
  return detailsData.Locations.filter(
    (location) =>
...
function getContacts(detailsData) {
  ...
  return detailsData.Contacts.map((contact) => {
