const advertiserData = [
  {
    Advertiserimg:
      "https://prod-shop-a-docket-s3.s3-ap-southeast-2.amazonaws.com/cdn/images/805002.jpg",
    ...
    Detail:
      "<p>General Was $310</p><p>Service Now $155*</p><ul><li>Under vehicle</li><li>Brakes</li><li>Steering</li><li>Oil & filter change (up to 5L)</li></ul><p>Find us on facebook.com/SEQAutocare</p>",
    About:
      "<b>SEQ Autocare</b> is a highly recommended workshop for all makes and models. Tyres, Air Conditioning and Safety Certificates are just part of what we do.",
    Contacts: [
      {
        contactType: "Address",
        contactMethod:
          "Shed 5, 1505 Nambour North Connection Rd Yandina QLD 4561",
        contactLink:
          "https://maps.google.com.au/maps?f=d&daddr=Shed%205,%201505%20Nambour%20North%20Connection%20Rd,%20Yandina",
        contactIcon: "mapPin",
      },
      {
        contactType: "Phone",
    ...
    Terms:
      "<ul><li>*Some 6-cylinder vehicles, V8 & 4WDs may cost extra</li><li>Not a Log Book Service</li></ul>",
  },
];
